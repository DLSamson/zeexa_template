...
!function (e, t) { "use strict"; "object" == typeof module && "object" == typeof module.exports ? module.exports = e.document ? t(e, !0) : function (e) { if (!e.document) throw new Error("jQuery requires a window with a document"); return t(e) } : t(e) }("undefined" != typeof window ? window : this, (function (e, t) {
    ...
    $(".employees-slider").slick({ slidesToShow: 4, slidesToScroll: 1, arrows: !1, dots: !0, responsive: [{ breakpoint: 1250, settings: { slidesToShow: 3, slidesToScroll: 1 } }, { breakpoint: 1250, settings: { slidesToShow: 3, slidesToScroll: 1 } }, { breakpoint: 950, settings: { slidesToShow: 2, slidesToScroll: 1 } }, { breakpoint: 550, settings: { slidesToShow: 1.5, slidesToScroll: 1, infinite: !1 } }] }), $(".about-slider").slick({ slidesToShow: 1, slidesToScroll: 1, arrows: !1, dots: !0, variableWidth: !0, centerMode: !0, infinite: !0, responsive: [{ breakpoint: 1450, settings: { slidesToShow: 1, slidesToScroll: 1 } }, { breakpoint: 950, settings: { slidesToShow: 2, slidesToScroll: 1 } }, { breakpoint: 550, settings: { slidesToShow: 1.5, slidesToScroll: 1, infinite: !1 } }] }), $(".confidence-slider").slick({ slidesToShow: 2, slidesToScroll: 1, arrows: !1, dots: !0, responsive: [{ breakpoint: 650, settings: { slidesToShow: 1, slidesToScroll: 1 } }] }), $(".offer-slider").slick({ adaptiveHeight: true, slidesToShow: 3, slidesToScroll: 1, arrows: !1, dots: !0, variableWidth: !0, infinite: !1, responsive: [{ breakpoint: 1450, settings: { variableWidth: !1, infinite: !0 } }, { breakpoint: 1100, settings: { slidesToShow: 2, slidesToScroll: 1, variableWidth: !1, infinite: !0 } }, { breakpoint: 400, settings: { slidesToShow: 1.5, slidesToScroll: 1, infinite: !1 } }] }), $(".stock-slider").slick({ slidesToShow: 3, slidesToScroll: 1, arrows: !1, dots: !0, variableWidth: !0, infinite: !1, responsive: [{ breakpoint: 1450, settings: { variableWidth: !1, infinite: !0 } }, { breakpoint: 1100, settings: { slidesToShow: 2, slidesToScroll: 1, variableWidth: !1, infinite: !0 } }, { breakpoint: 400, settings: { slidesToShow: 1.5, slidesToScroll: 1, infinite: !1 } }] }), $(".slider").slick({ slidesToShow: 1, slidesToScroll: 1, arrows: !1, dots: !0 }), $(".questions-accardion__btn").on("click", (function () { $(this).next().slideToggle(500) })), $(".stock-accardion__btn").on("click", (function () { $(this).next().slideToggle(500) }))
})), window.addEventListener("DOMContentLoaded", () => { const e = document.querySelector(".about-tabs__item1"), t = document.querySelectorAll(".about-tabs__item-btn"), n = document.querySelectorAll(".about-tabs__content"); function i() { n.forEach(e => { e.classList.add("hide"), e.classList.remove("show") }), t.forEach(e => { e.classList.remove("tabs-active") }) } function o(e) { n[e].classList.add("show"), n[e].classList.remove("hide"), t[e].classList.add("tabs-active") } e && e.addEventListener("click", e => { const n = e.target; n && n.classList.contains("about-tabs__item-btn") && t.forEach((e, t) => { n == e && (i(), o(t)) }) }), e && t && n && (i(), o(0)); const r = document.querySelector(".personal-tabs__item"), s = document.querySelectorAll(".personal-tabs__item-btn"), a = document.querySelectorAll(".personal-tabs__content"); function l() { a.forEach(e => { e.classList.add("hide"), e.classList.remove("show") }), s.forEach(e => { e.classList.remove("personal-tabs--active") }) } function c(e) { a[e].classList.add("show"), a[e].classList.remove("hide"), s[e].classList.add("personal-tabs--active") } r && r.addEventListener("click", e => { const t = e.target; t && t.classList.contains("personal-tabs__item-btn") && s.forEach((e, n) => { t == e && (l(), c(n)) }) }), r && s && a && (l(), c(0)); const d = document.querySelector(".entry-modal"), u = document.querySelector(".entry-form__close"), p = document.querySelector(".entry__btn"); p && (p.addEventListener("click", () => { d.classList.add("entry-form__show"), d.classList.remove("entry-form__hide") }), u.addEventListener("click", () => { d.classList.add("entry-form__hide"), d.classList.remove("entry-form__show") })); const f = document.querySelector(".garage"), h = document.querySelector(".garage__block__close"), v = document.querySelector(".garage__button"); v && (v.addEventListener("click", () => { f.classList.add("entry-form__show"), f.classList.remove("entry-form__hide") }), h.addEventListener("click", () => { f.classList.add("entry-form__hide"), f.classList.remove("entry-form__show") })) });